  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Create a new direct client record.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Client Details</CardTitle>
          <CardDescription>Enter the company and contact information for this client.</CardDescription>
        </CardHeader>
        <CardContent>
          <form action={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="contact_name" name="contact_name" required placeholder="John Doe" />
            </div>
